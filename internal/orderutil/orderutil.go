...
func QuoteBuyPrice(ctx context.Context, g ports.BestPriceGetter, assetID string, maxCents int) (domain.Price, error) {
	if g == nil {
...
func QuoteBuyPriceOr(ctx context.Context, g ports.BestPriceGetter, assetID string, maxCents int, fallback domain.Price) (domain.Price, error) {
...
func QuoteSellPrice(ctx context.Context, g ports.BestPriceGetter, assetID string, minCents int) (domain.Price, error) {
	if g == nil {
		return domain.Price{}, fmt.Errorf("BestPriceGetter 为空")
	}
